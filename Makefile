...
SRC:=$(GOPATH)/src/github.com/jiqixiaomao/reporter
...
.PHONY: build
build: 
	go install -v github.com/jiqixiaomao/reporter/cmd/grafana-reporter

.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/jiqixiaomao/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t jiqixiaomao/grafana-reporter:2.3.0 -t jiqixiaomao/grafana-reporter:latest .

docker-push:
	@docker push jiqixiaomao/grafana-reporter
